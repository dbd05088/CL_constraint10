...
# CIL CONFIG
NOTE="mir_cifar10_std_check_real_match" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="mir"
...
if [ "$DATASET" == "cifar10" ]; then
    MEM_SIZE=50000 ONLINE_ITER=0.324323256
