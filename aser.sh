...
# CIL CONFIG
NOTE="aser_cifar10_std_check_real_check_match_mem5000" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="aser"
...
if [ "$DATASET" == "cifar10" ]; then
    MEM_SIZE=5000 ONLINE_ITER=1 #0.16666667
    N_SMP_CLS="4" K="3"
...
do
    CUDA_VISIBLE_DEVICES=0 nohup python main.py --mode $MODE --n_worker 8 \
