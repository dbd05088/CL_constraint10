...
class MemoryDataset(Dataset):
    def __init__(self, dataset, transform=None, cls_list=None, device=None, test_transform=None,
                 data_dir=None, transform_on_gpu=True, save_test=None, keep_history=False, use_kornia=True, buf_transform=None, cls_weight_decay=None, weight_option=None, weight_ema_ratio=None, use_human_training=False, klass_warmup = None):
    ...
    @torch.no_grad()
    def get_batch(self, batch_size, stream_batch_size=0, use_weight=None, transform=None, twf=False, recent_ratio=None, exp_weight=False, prev_batch_index=None, weight_method=None, n_class=None, avg_prob=None):
